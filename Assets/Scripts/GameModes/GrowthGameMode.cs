...
namespace Assets.Scripts.GameModes {
    internal class GrowthGameMode : GameMode {
        ...
        public ComplicationPreview complicationPreview;
        ...
        new void Update() {
            ...
            if (!GameController.enhancedSongController.IsFading && !GameController.simpleSongController.IsFading && !GameController.GameOver && !GameController.Paused) {
